    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <main className="max-w-[1400px] mx-auto px-4 py-6">
        ...
        {gameOver ? (
          <button
            onClick={restartGame}
            className="w-full max-w-md mx-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2"
          >
