    ...
    <>
      ...
      >
        <div
          ...
          } transition-colors duration-200 flex flex-col items-center justify-center min-h-[160px] relative`}
        >
          {revealed ? (
            <>
              {(type === 'flag' || type === 'map') ? (
              ...
              <div className="mt-2 text-sm text-gray-200 uppercase tracking-wide">
